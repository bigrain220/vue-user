<template>
    <div id="keywords">
        ...
        <el-dialog title="编辑文章" :visible.sync="visible.editArticle"  width="50%">
        ...
        <el-dialog title="添加文章" :visible.sync="visible.addArticle"  width="50%">
...
export default {
    ...
    data() {
        return {
            ...
            Editform:{title:'', status:'1',content:''},
            Addform:{title:'', status:'1',content:''},
            rules:{
    ...
    methods: {
        ...
        addArticle(){
            ...
            // this.Addform = {title:'', status:'1', content:''}
        },
        articleMake(){
