    ...
    <div id="auto-keywords">
        ...
        <el-dialog title="编辑文章" :visible.sync="visible.editArticle"  width="65%">
            <el-form :model="Editform" :rules="rules" ref="Editform" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="状态" prop="staus" style="margin-bottom:0;">
        ...
        <el-dialog title="添加文章" :visible.sync="visible.addArticle"  width="65%">
            <el-form :model="Addform" :rules="rules" ref="Addform" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="内容" prop="content" style="margin-bottom:0;">
...
<style>
 #auto-keywords .el-dialog__body{padding-bottom: 10px;}
 @media screen and (min-width: 1700px) {
        #auto-keywords .el-dialog{width: 50%!important}
    }
</style>