...
*/
var tuijiankeyArray = ['服务为先','欢迎来电','欢迎咨询','信息推荐','首页推荐','值得信赖','诚信服务','服务至上','诚信为本','客户至上','优质推荐','口碑推荐','信誉保证','来电咨询','推荐咨询','诚信经营','铸造辉煌','承诺守信','诚信互利','创造辉煌','卓越服务','以客为尊','创新服务','售后完善']
var houzhuikeywordArray = ['厂家','生产厂家','报价','价格','厂家价格','厂家报价','联系方式','定制','哪家好','哪家强','怎么选','选哪家','有哪些','找哪家'];
var qianzhuikeywordArray = ['定做','专业','正规','设计','生产','供应','高端','靠谱','放心','知名','资深'];
var citys = [
  {
    "name" : "北京市",
    "city" : [ {
  ...
  },
  {
    ...
    "city" : [ {
      "name" : "台湾",
      "area" : [ "台北市", "高雄市", "台北县", "桃园县", "新竹县", "苗栗县", "台中县", "彰化县", "南投县", "云林县", "嘉义县", "台南县", "高雄县", "屏东县", "宜兰县", "花莲县", "台东县", "澎湖县", "基隆市", "新竹市", "台中市", "嘉义市", "台南市" ]
    } ]
  },
  {
    "name" : "澳门特别行政区",
  ...
  },
  {
    ...
    "city" : [ {
      "name" : "香港",
      "area" : [ "中西区", "湾仔区", "东区", "南区", "深水埗区", "油尖旺区", "九龙城区", "黄大仙区", "观塘区", "北区", "大埔区", "沙田区", "西贡区", "元朗区", "屯门区", "荃湾区", "葵青区", "离岛区" ]
    } ]
  }
];
